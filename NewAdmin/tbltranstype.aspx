<%@ Page Title="" Language="C#" MasterPageFile="~/AcmMaster.master" AutoEventWireup="true" CodeBehind="tbltranstype.aspx.cs" Inherits="NewAdmin.tbltranstype"  %>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">tbltranstype</span>
                                    </div>
                                    <div class="actions btn-set">
                                        <div class="btn-group btn-group-circle btn-group-solid">
                                            ...
                                            <asp:Button ID="btnLast" class="btn blue" runat="server" Text="Last" OnClick="btnLast_Click" />
                                        </div>

                                        <asp:Button ID="btnAdd" runat="server" class="btn green-haze btn-circle" ValidationGroup="submit" Text="Update " OnClick="btnSave_Click" />
                                    ...
                                    <div class="tab-pane active" id="tab_general2">
                                        <div class="table-container" style="">
                                            <div class="portlet box blue-hoki">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="fa fa-globe"></i>tbltranstype List
                                                    </div>
